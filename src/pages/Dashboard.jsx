      ...
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="animate-slide-up animation-delay-100">
            <StatCard
              title="Total Deudas"
              value={<MoneyDisplay amount={stats.total_deudas || 0} size="3xl" color="white" />}
              subtitle="Por cobrar"
          ...
          <div className="animate-slide-up animation-delay-200">
            <StatCard
              title="Pagos Hoy"
              value={<MoneyDisplay amount={stats.pagos_hoy || 0} size="3xl" color="white" />}
              subtitle="Recibidos"
          ...
          <div className="animate-slide-up animation-delay-300">
            <StatCard
              title="Ventas Hoy"
              value={<MoneyDisplay amount={stats.ventas_hoy || 0} size="3xl" color="white" />}
